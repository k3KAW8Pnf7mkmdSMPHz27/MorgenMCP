...
def _format_calendar(cal) -> CalendarItem:
        ...
        filter_none_values(
            {
                ...
                "permissions": filter_none_values(
                    {
                        "canRead": cal.my_rights.may_read_items
                        if cal.my_rights
                        else None,
                        "canWrite": cal.my_rights.may_write_all
                        if cal.my_rights
                        else None,
                        "canDelete": cal.my_rights.may_delete
                        if cal.my_rights
                        else None,
                    }
                )
...
@handle_tool_errors
async def list_calendars() -> ListCalendarsResult:
